 ...
 *  After uploading the code connet esp32 with Wi-Fi then go to chrome search IP 192.168.4.1 and injoy it
 ***************************************************/
#include <Arduino.h>
#include <WiFi.h>
#include <AsyncTCP.h>
...
const char* ssid     = "xxxxxxxxx"; //Enter Wi-Fi Name
const char* password = "xxxxxxxxx"; //Enter Wi-Fi Password 
...
<html>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    ...
    input[type=button]
    {
      background-color:blue;color:white;border-radius:30px;width:100%;height:40px;font-size:20px;text-align:center;
    }
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: teal;text-align:center;">AV ELECTRO TECH</h1>
    <h2 style="color: teal;text-align:center;">Robotic ARM</h2>
